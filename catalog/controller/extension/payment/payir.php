...
class ControllerExtensionPaymentPayir extends Controller
{
    public function index()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/extension/payment/payir.tpl')) {

            return $this->load->view($this->config->get('config_template') . '/extension/payment/payir.tpl', $data);

        } else {

            return $this->load->view('/extension/payment/payir.tpl', $data);
        }
    }
    ...
    public function callback()
    {
        ...
        if ($data['error_warning']) {
            ...
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/extension/payment/payir_callback.tpl')) {

                $this->response->setOutput($this->load->view($this->config->get('config_template') . '/extension/payment/payir_callback.tpl', $data));

            } else {

                $this->response->setOutput($this->load->view('extension/payment/payir_callback.tpl', $data));
            }
